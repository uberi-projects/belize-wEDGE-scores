...
4. **Download Range Maps for Birds** Download the Species' Distribution Maps from [BirdLife DataZone] (https://datazone.birdlife.org/contact-us/request-our-data). Once downloaded, load it into ArcGIS Pro/QGIS and clip file using the desired country boundary shapefile. Save the clipped file and add all its contents to the data_deposit folder of the project.
