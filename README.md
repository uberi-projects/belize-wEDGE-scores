...
4. **Download Range Maps for Birds** Download the Species' Distribution Maps from [BirdLife DataZone](https://datazone.birdlife.org/contact-us/request-our-data). Once downloaded, load it into ArcGIS Pro/QGIS and clip file using the Belize boundary [Shapefile](http://www.biodiversity.bz/). Save the clipped file and add all its contents to the data_deposit folder of the project.
5. Simply **run the R script** "run_project.r", which will result in an output file, "wEDGE_all.csv," for your use.
